...
- **[[2.Case Sensitivity|Case Sensitivity]]**: Unlike Windows, the Linux filesystem is case-sensitive. This means `File.txt` and `file.txt` are viewed as two entirely different entities.
- **[[3.Directory|Directory]]**: This term has two distinct meanings in Linux:
...
- **[[6.Script|Script]]**: These are files containing a series of commands executed by an interpreter (like Bash or Python). Many hacking tools are essentially complex scripts.
...
- **[[5.Root|/root]]**: The home directory for the superuser (not to be confused with `/`).
- **/etc**: Contains the configuration files that control how the system and programs start.
- **[[4.Home|/home]]**: Where standard user files are kept.
