...
- **[[2.Case Sensitivity]]**: Unlike Windows, the Linux filesystem is case-sensitive. This means `File.txt` and `file.txt` are viewed as two entirely different entities.
- **[[3.Directory]]**: This term has two distinct meanings in Linux:
